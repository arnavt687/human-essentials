...
A demand-forecasting and inventory-policy module for Human Essentials, added by
**Arnav** ([@arnavt687](https://github.com/arnavt687)) on top of Ruby for Good's
open-source [Human Essentials](https://github.com/rubyforgood/human-essentials).
...
Human Essentials is built and maintained by [Ruby for Good](https://rubyforgood.org)
and 115+ contributors under the MIT License. This module builds on their
data model (items, distributions, requests, event-sourced inventory) and
UI framework. The forecasting, inventory-policy and allocation code described
above is new work in this fork.
